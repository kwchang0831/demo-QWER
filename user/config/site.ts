...
import Avatar_128 from '$assets/avatar.webp?w=128&h=128&format=avif;webp&imagetools';
import Avatar_48_PNG from '$assets/avatar.webp?w=48&h=48&imagetools';
import Avatar_96_PNG from '$assets/avatar.webp?w=96&h=96&imagetools';
import Avatar_192_PNG from '$assets/avatar.webp?w=192&h=192&imagetools';
import Avatar_512_PNG from '$assets/avatar.webp?w=512&h=512&imagetools';
  ...
  custom: ({ dev }) =>
    dev
      ...
      : [
          ...
          '<script defer data-domain="svelte-qwer.netlify.app" src="https://plausible.kwchang0831.dev/js/plausible.js"></script>',
        ],
};
...
export const giscusConfig: Giscus.Config = {
  ...
  enable: true,
  id: 'giscus-comment',
  repo: 'kwchang0831/demo-QWER',
  repoId: 'R_kgDOIBVF4A',
  category: 'BlogComments',
  categoryId: 'DIC_kwDOIBVF4M4CRgW_',
  mapping: 'pathname',
  reactionsEnabled: '1',
  emitMetadata: '0',
  inputPosition: 'top',
